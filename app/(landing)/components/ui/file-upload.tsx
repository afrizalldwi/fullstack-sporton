...
function FileUpload({ onFileSelect }: TFileUploadProps) {
    ...
    >
      ...
      {!file ? (
        <div className="text-center my-5">
          <FiUploadCloud size={24} className="text-primary mx-auto mb-1.5" />
        ...
        <div className="text-center">
          ...
          <button
            onClick={removeFile}
            className="flex gap-2 bg-primary/90 text-white mx-auto cursor-pointer rounded mt-4 px-2"
          >
